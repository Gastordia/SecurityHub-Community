...
from ..models import Project, ProjectScope, Vulnerability

logger = logging.getLogger(__name__)

def validate_project_completeness(project_or_id):
    """
    ...
    Args:
        project_or_id (int | Project): Project ID or already scoped Project instance
    ...
    try:
        ...
        scopes_count = ProjectScope.objects.filter(project=project).count()
